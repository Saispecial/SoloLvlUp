...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!body.player) {
      ...
      const nameContext = body.player.name ? `The Hunter's name is: ${body.player.name}. Always use this name for personalization if the user asks about their name or refers to themselves as Hunter.` : ""
