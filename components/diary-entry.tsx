...
export function DiaryEntryComponent({ isMobile = false }: DiaryEntryProps) {
  const { addDiaryEntry, convertDiaryToReflection, deleteDiaryEntry, getDiaryEntries, getReflections } = usePlayerStore()
                ...
                diaryEntries.map((entry) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="p-4 rounded-lg bg-gray-800/50 border border-gray-700 hover:border-blue-400/50 transition-colors"
                    >
